...
class User(db.Model):
    ...
    def register(cls,username,password, first_name, last_name, email):
        ...
        # what utf8 does is turn bytestring into normal string
    ...
    def authenticate(cls,username,password):
        ...
        # we use .first() because with other methods if there is no matching user it will crash and break. .first method is more forgiving  
